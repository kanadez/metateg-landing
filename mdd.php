...
function mobile_device_detect($iphone=true,$ipad=true,$android=true,$opera=true,$blackberry=true,$palm=true,$windows=true,$mobileredirect="http://m.metateg.pro",$desktopredirect="http://metateg.pro"){
    global $constructor;
